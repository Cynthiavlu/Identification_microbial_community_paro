...
######################################################################
THREADS=8
DB=/home/user/NCBI_16s_db/16S_ribosomal_RNA  #e.g. PRJNA33175 BioProject for Bacterial 16S
BLASTN=blastn
SEQTK=seqtk
######################################################################
...
$BLASTN -db $DB -query $WORKING_DIR"/"$SAMPLE_NAME".fasta" -num_threads $THREADS -outfmt "6 qseqid evalue salltitles" -max_target_seqs 1 -perc_identity 0.90 -qcov_hsp_perc 0.3 \
