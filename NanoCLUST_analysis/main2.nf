...
if(params.multiqc){
 ...
 process consensus_classification {
     ...
     if(!params.db)
        """
        blastn -query $consensus -db nr -remote -entrez_query "Bacteria [Organism]" -task blastn -dust no -outfmt "10 staxids sscinames evalue length score pident" -evalue 1E-40 -max_hsps 50 -max_target_seqs 5 > consensus_classification.csv
        ...
        blastn -query $consensus -db $db -task blastn -dust no -outfmt "10 sscinames staxids evalue length pident" -evalue 1E-40 -max_hsps 50 -max_target_seqs 5 | sed 's/,/;/g' > consensus_classification.csv
